...
const TemplateBox2: React.FC<TemplateBox2Props> = ({
  ...
  return (
    <div
      className="bg-white rounded-xl p-6 shadow-lg w-full max-w-6xl flex flex-col justify-between h-[80vh]"
      style={{ fontFamily: "Roboto, sans-serif" }}
    >
      <div
        className={`bg-gray-200 rounded-md relative overflow-hidden flex flex-1 ${
